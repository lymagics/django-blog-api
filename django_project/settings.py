...
REFRESH_TOKEN_IN_BODY = env.bool('REFRESH_TOKEN_IN_BODY')
REFRESH_TOKEN_IN_COOKIE = env.bool('REFRESH_TOKEN_IN_COOKIE')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Blog API',
    'DESCRIPTION': 'Lightweight blog api written in Django.',
    'VERSION': '1.0.0',
}
